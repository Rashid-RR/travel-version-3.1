...
const Book = () => {
    return (
        <section id="about_whyus" className="our-features element">
            <header className="section-header">
                <h2 className="section-title text-white">Why Book with Us</h2>
                <div className="section-content">
                    <p>Let your visitors know why they should trust you and book with you. You can modify this section from Appearance &gt; Customize &gt; Home Page Settings &gt; Why Book with Us.</p>
                </div>
            </header>
                        ...
                        <div className="col">
                            <div className="icon-holder">
                                <svg width="60" height="60">
                                    <circle cx="14" cy="29" r="29" transform="rotate(-90, 22, 22)"></circle>
                                </svg>
                                <svg className="svg-inline--fa fa-check fa-w-16" aria-hidden="true" data-prefix="fa" data-icon="check" role="img"
                            ...
                            <div className="text-holder">
                                <h3 className="title">TripAdvisor Multiple Award winning company</h3>
